...
function drawBackground(){
    ...
    if(currentLevel === 1){
        ...
        _0x5db249[_0x1937ba(0x177)](0x0, '#ff8c00'); _0x5db249[_0x1937ba(0x177)](0.5, '#ff4500'); _0x5db249[_0x1937ba(0x177)](1, '#8b0000');
        ctx[_0x1937ba(0x14a)]=_0x5db249; ctx['fillRect'](0,0,window[_0x1937ba(0x166)],window[_0x1937ba(0x14c)]);
        ...
        _0x5db249[_0x1937ba(0x177)](0x0, '#87ceeb'); _0x5db249[_0x1937ba(0x177)](1, '#1e3a8a');
        ctx[_0x1937ba(0x14a)]=_0x5db249; ctx['fillRect'](0,0,window[_0x1937ba(0x166)],window[_0x1937ba(0x14c)]);
        ...
        const intensity = Math.min((currentLevel-3)*0.12, 1);
        _0x5db249[_0x1937ba(0x177)](0x0, '#0a0a2e'); _0x5db249[_0x1937ba(0x177)](1, '#1a0033');
        ctx[_0x1937ba(0x14a)]=_0x5db249; ctx['fillRect'](0,0,window[_0x1937ba(0x166)],window[_0x1937ba(0x14c)]);
        drawStarsAndGalaxy(intensity);
        drawHill(hill1BaseHeight,hill1Amplitude,hill1Stretch,'#2c1a4d');
        drawHill(hill2BaseHeight,hill2Amplitude,hill2Stretch,'#1f1438');
    }
    trees['forEach'](_0x39f209=>drawTree(_0x39f209['x'],_0x39f209['color']));
}

function drawFireEffect(){
    ctx.fillStyle = 'rgba(255, 80, 0, 0.7)';
    for(let i = 0; i < 10; i++){
        const x = 30 + i * 70 + Math.sin(Date.now()/200 + i) * 25;
        const height = 70 + Math.random()*40;
        ctx.fillRect(x, window.innerHeight - height, 22, height);
    }
}
...
function drawWaterWaves(){
    ...
    for(let i = 0; i < 7; i++){
        ctx.beginPath();
        ctx.moveTo(0, window.innerHeight - 80 - i*16);
        for(let x = 0; x < window.innerWidth; x += 25){
            ctx.lineTo(x, window.innerHeight - 80 - i*16 + Math.sin(x/35 + Date.now()/300) * 14);
        }
        ctx.stroke();
    }
}

function drawStarsAndGalaxy(intensity){
    ctx.fillStyle = 'white';
    for(let i = 0; i < 120; i++){
        const x = (i * 37 + Date.now()/40) % window.innerWidth;
        const y = 40 + (i % 45) * 16;
        const size = (i % 4) + 1.2;
